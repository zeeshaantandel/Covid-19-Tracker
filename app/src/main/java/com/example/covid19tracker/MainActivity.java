/*name- zeeshaan tandel (1806128)
        aditya soude (1806118)
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private void updateGraph(int active, int total, int recovered, int deaths) {
        ...
        mpiechart.addPieSlice(new PieModel("Total cases",total,Color.parseColor("#FFB701")));
        mpiechart.addPieSlice(new PieModel("Active cases",active,Color.parseColor("#FF4CAF50")));
        mpiechart.addPieSlice(new PieModel("Recovered cases",recovered,Color.parseColor("#38ACCD")));
